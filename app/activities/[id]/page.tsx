          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              >
                ...
                <div>
                  <span
                    ...
                    style={{ background: "#E8A020", color: "#1A2744" }}
                  >
                    {activity.type}
                  </span>
              ...
              <div className="p-6 grid sm:grid-cols-2 gap-4">
                {[
                  {
                    icon: <Calendar size={16} style={{ color: "#D63B3B" }} />,
                    label: "Date",
                    value: activity.date,
                  },
                  {
                    icon: <Clock size={16} style={{ color: "#D63B3B" }} />,
                    label: "Time",
                    value: activity.time,
                  },
                  {
                    icon: <MapPin size={16} style={{ color: "#D63B3B" }} />,
                    label: "Location",
                    value: activity.location,
                  },
                  {
                    icon: <Users size={16} style={{ color: "#D63B3B" }} />,
                    label: "Capacity",
            ...
            >
              ...
              <div className="mb-5">
                <div className="flex justify-between text-xs mb-2">
                  ...
                  <span
                    style={{ color: spotsLeft <= 0 ? "#D63B3B" : "#E8A020" }}
                  >
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${pct}%`,
                      background: pct > 80 ? "#D63B3B" : "#28B4C8",
                    }}
                  />
                </div>
              </div>
